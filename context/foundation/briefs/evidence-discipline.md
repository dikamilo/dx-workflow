...
- Coverage: 35 claims — 30 sourced (interview 0, data 0, document 18, product 1, benchmark 11), 0 synthetic, 5 assumed
...
| D05 | 2026-09-18 | Sources are paths, not copies — no `.sources/` directory and no verbatim appendix | The expected case is material already in the project | `[DOCUMENT]` `plan.md` §Approach | not recorded | proposal |
