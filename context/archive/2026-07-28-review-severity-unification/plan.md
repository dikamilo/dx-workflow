...
### Phase 2: Update `dx-plan-review` and `dx-impl-review` to match
#### Automated
- [x] 2.1 `dx-plan-review/SKILL.md` confirmed/updated to match the new finding format — 1155493
- [x] 2.2 `dx-impl-review/SKILL.md` updated to emit `[<Dimension>: <Severity>]` tags — 1155493

### Phase 3: Sync `docs/reference/skills.md`
#### Automated
- [x] 3.1 `/dx-impl-review` Writes line updated to name the compound tag; `/dx-plan-review` Writes line confirmed unchanged — 5f6fa51
