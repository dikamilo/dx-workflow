...
### Phase 2: Wire into CI as a required gate
#### Automated
- [ ] 2.1 `lint-skills` job added to `.github/workflows/changeset-gate.yml`, mirrors `check-changeset`'s checkout/setup-node/npm-ci steps
#### Manual
- [ ] 2.2 Workflow YAML reviewed for validity (no PR exists yet to trigger a live run)
