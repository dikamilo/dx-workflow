---
name: dx-references
description: Loads a dx shared reference document by topic. Invoked by other dx- skills to pull in shared reference material (change-md, effort-md, progress-format, plan-template, interview, module-design, knowledge-layer, review-report, untrusted-content).
