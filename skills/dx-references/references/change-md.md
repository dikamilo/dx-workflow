...
Skills stamp the transition they cause; nothing blocks on it. A change may also carry optional siblings in its folder: `research/<topic>.md`, `frame.md`, `diagnosis.md` (when promoted from `dx-diagnose`), `plan.md` (owns `## Progress`), `reviews/`.
